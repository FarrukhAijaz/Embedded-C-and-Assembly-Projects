 ...
 * @param result  Char array used to store the return value, the scaled integer as a character array.
 * ...
...
int main() {
    ...
    char scaled[6];           // Declare a character array to store the scaled reading as a string.
